        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="mt-5 max-w-2xl mx-auto text-slate-500">
              ...
              sustainable energy solutions across Maharashtra, Karnataka and
              Goa.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -right-8 top-10 space-y-5">
                <div className="bg-white rounded-3xl p-6 shadow-xl w-48">
                  <h3 className="text-4xl font-black text-emerald-500">500+</h3>

                  <p className="text-slate-500 mt-1">Projects Completed</p>
                </div>

                <div className="bg-white rounded-3xl p-6 shadow-xl w-48">
                  <h3 className="text-4xl font-black text-blue-600">25+</h3>

                  <p className="text-slate-500">Years Performance</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <span className="text-emerald-500 font-semibold">WHO WE ARE</span>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-500">
                WattWorks Energies Private Limited provides end-to-end solar EPC
                solutions for residential, commercial and industrial customers.
                Our experienced engineering team designs, installs and maintains
                high-performance solar systems that reduce electricity costs
